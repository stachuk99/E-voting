...
namespace EVoting_backend.DB.Migrations
{
    ...
    [Migration("20211206150844_init migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EVoting_backend.DB.Models.UserFormRelation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("EVoting_backend.DB.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
